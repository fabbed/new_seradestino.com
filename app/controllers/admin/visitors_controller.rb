...
class Admin::VisitorsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     Visitor: create, read, update, destroy, custom_action
  #
  #   editor:
  #     Visitor: create, read, update, custom_action_for_an_item
  #
