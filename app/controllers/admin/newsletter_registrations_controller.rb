...
class Admin::NewsletterRegistrationsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     NewsletterRegistration: create, read, update, destroy, custom_action
  #
  #   editor:
  #     NewsletterRegistration: create, read, update, custom_action_for_an_item
  #
