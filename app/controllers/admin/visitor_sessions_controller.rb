...
class Admin::VisitorSessionsController < Admin::MasterController
...
=begin
  ...
  #
  #   admin:
  #     VisitorSession: create, read, update, destroy, custom_action
  #
  #   editor:
  #     VisitorSession: create, read, update, custom_action_for_an_item
  #
