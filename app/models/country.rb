class Country < ActiveRecord::Base
  ...
  def self.for_country_select_in_surves
    [["Seleciona...", "none"]] |    [['Argentina', 12], ['Bolivia', 29], ['Brasil', 32], ['Chile', 42], ['Colombia', 46], ['Costa Rica', 52], ['Ecuador', 57], ['El Salvador', 59], ['España', 64], ['Estados Unidos', 65], ['Guatemala', 82], ['Honduras', 89], ['México', 148], ['Nicaragua', 159], ['Noruega', 163], ['Panamá', 171], ['Paraguay', 173], ['Perú', 174], ['Puerto Rico', 178], ['República Dominicana', 184], ['Uruguay', 231], ['Venezuela', 234]]
  end


  def self.for_gender_select_in_surves
    
        [["Seleciona...", "none"]] | [[ "hombre", "m" ], [ "mujer", "f" ]]
